...
The app is built using **React** and leverages **React Router** for navigation, and communicates to a back end rails application that lives here: https://github.com/wally-yawn/mod_3_final_be
